...
router.delete('/api/delete_torneo', Api_key, deleteTorneo);
router.post('/api/asignar_categoria_torneo', Api_key, asignarCategoriaATorneo);
router.put('/api/update_participacio_torneo', Api_key, updateCategoria);
